...
{
    @MyColumn(  table = "account",name = "balance",nullable = false,unique = false,type = ColumnType.DECIMAL,
                length = 0,pk = false,fk = false,reference = "",delete = "cascade")
    protected double balance;

    @MyColumn(  table = "account",name = "number",nullable = false,unique = true,type = ColumnType.INT,
            length = 0,pk = false,fk = false,reference = "",delete = "cascade")
    protected String number;

    @MyColumn(  table = "account",name = "type",nullable = false,unique = false,type = ColumnType.VARCHAR,
